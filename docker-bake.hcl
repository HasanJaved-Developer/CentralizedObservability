...
variable "REPO_SLUG"     { default = "centralized-observability" }     // your namespace/group
...
target "userapi" {
  ...
  labels = {
    "org.opencontainers.image.source" = "https://github.com/${OWNER}/CentralizedObservability"
